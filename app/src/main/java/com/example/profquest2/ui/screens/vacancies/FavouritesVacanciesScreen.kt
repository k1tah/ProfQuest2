...
@Composable
fun FavouritesVacanciesScreen(navController: NavController, viewModel: VacanciesViewModel = hiltViewModel()) {

    LaunchedEffect(key1 = true) {
        viewModel.getFavouritesVacancies()
    }
    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            TitleText(text = stringResource(id = R.string.favourites))
