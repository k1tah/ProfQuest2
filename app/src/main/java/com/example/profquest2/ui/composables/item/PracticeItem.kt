    ...
    Card(
        ...
        Column(modifier = Modifier.padding(horizontal = 16.dp, vertical = 12.dp)) {
            Row(verticalAlignment = Alignment.CenterVertically) {
                PostIcon(fileId = practice.icon?.id.toString())
                Spacer(modifier = Modifier.width(16.dp))
                Column {
                    TitleText(text = practice.companyName)
                    Spacer(modifier = Modifier.height(2.dp))
                    LabelText(text = practice.date.formatDate() ?: "")
                }
            }
            Spacer(modifier = Modifier.height(16.dp))
            TitleText(text = practice.name)
            ...
            AnimatedVisibility(visible = expanded) {
                Column {
                    SubtitleText(text = stringResource(R.string.documents))
                    Spacer(modifier = Modifier.height(4.dp))
                    BodyText(text = practice.documents)
                    Spacer(modifier = Modifier.height(8.dp))

                    SubtitleText(text = stringResource(R.string.specialities))
                    Spacer(modifier = Modifier.height(4.dp))
                    BodyText(text = practice.specialities)
                    Spacer(modifier = Modifier.height(8.dp))

                    SubtitleText(text = stringResource(R.string.contacts))
                    Spacer(modifier = Modifier.height(4.dp))
                    BodyText(text = practice.email)
                    Spacer(modifier = Modifier.height(4.dp))
                    BodyText(text = practice.phone)
                    Spacer(modifier = Modifier.height(4.dp))
                    BodyText(text = practice.address)
                    Spacer(modifier = Modifier.height(8.dp))
